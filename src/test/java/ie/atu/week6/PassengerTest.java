...
class PassengerTest {
    ...
    void success_test_Title() {
        Passenger myPass = new Passenger("Mr", "Conor", "1111111111", 879543461L, 21);
    ...
    void test_fail_title_check() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, () -> {new Passenger ("Miss","Conor","1111111111",879543461L,21);});
    ...
    @Test
    void test_fail_name() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, () -> {new Passenger ("Mr","Oj","1111111111",879543461L,21);});
    ...
    void test_fail_ID_check() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, () -> {new Passenger ("Mr","Conor","12345",879543461L,21);});
    ...
    void test_fail_Phone_check() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, () -> {new Passenger ("Mr","Conor","1111111111",1L,21);});
    ...
    void test_fail_Age_check() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, () -> {new Passenger ("Mr","Conor","1111111111",879543461L,15);});
